...
let kSheetCellHeight: CGFloat = 100
var maxShareItemsCount: CGFloat = 5 //最大数组个数
var maxlineShowCount: CGFloat = 5 //每行显示
...
public class ShareView: UIView {
    ...
    public convenience init(title: String? = nil, 
        ...
        maxShareItemsCount = CGFloat((self.shareItems.first as! [ShareItem]).count)
    ...
    public convenience init(squareItems: [ShareItem], clickedHandler: ShareViewClickedHandler? = nil) {
        ...
        maxShareItemsCount = CGFloat(self.shareItems.count)
        collectionViewLayout.minimumInteritemSpacing = 0
        collectionViewLayout.minimumLineSpacing = 0
        collectionViewLayout.itemSize = CGSize(width: maxShareItemsCount > maxlineShowCount ? self.frame.width / maxlineShowCount : self.frame.width / maxShareItemsCount, height: kSheetCellHeight)
    }
    ...
    func defaultFooterView() -> UIView {
        ...
        footerView.frame = CGRect(x: 0, y: 0, width: self.frame.width, height: 60 + YMKDvice.bottomOffset())
        
        let view = UIView(frame: CGRect(x: 0, y: 0, width: self.frame.width, height: 10))
        view.backgroundColor = UIColor(hex6: 0xf2f2f2)
        ...
        cancelButton.frame = CGRect(x: 0, y: 10, width: self.frame.width, height: 50)
